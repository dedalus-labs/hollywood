...
managed by Dedalus Labs, Inc. (the "Maintainer"). To clarify the
intellectual property license granted with Contributions from any person or
entity, the Maintainer must have on file a signed Contributor License
Agreement ("CLA") from each Contributor, indicating agreement with the
license terms below. This agreement is for your protection as a Contributor
as well as the protection of the Maintainer and its users. It does not
...
For this repository, CLA acceptance is recorded when a maintainer adds your
GitHub handle to `VOUCHED.td` after you confirm acceptance in a Vouch Request
issue.
...
employer has waived such rights for your Contributions to the Maintainer,
