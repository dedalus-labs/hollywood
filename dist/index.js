...
import { A as stepOutput, C as needsResultIs, D as secret, E as runner, M as valueOr, O as selectString, S as needsResultIn, T as or, _ as isGitHubTypedMatrix, a as contains, b as needsOutput, c as eq, d as format, f as gh, g as input, h as hashFiles, i as cancelled, j as success, k as startsWith, l as expr, m as githubTypedMatrixValues, n as always, o as defineMatrix, p as github, r as and, s as envVar, t as GitHubJobResult, u as failure, v as matrix, w as not, x as needsResult, y as ne } from "./expressions-DFUA_wtk.js";
...
const command = (options) => {
	...
	for (const argument of options.args) assertNoNullByte(argument, "command argument");
	return {
		kind: "command",
		file: options.file,
		args: [...options.args],
...
const unsafeShell = (script) => {
	if (script.trim() === "") throw new Error("unsafeShell script is required");
...
const assertCommandFile = (file) => {
	if (file.trim() === "") throw new Error("command file is required");
	assertNoNullByte(file, "command file");
	if (file.includes("${{")) throw new Error("command file must be a literal executable path");
};
const assertNoNullByte = (value, name) => {
